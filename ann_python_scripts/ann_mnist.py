...
def BuildANN():
    ...
    os.system(cmd)
    os.system('move allbiases_formatted.h outputs/.')
    os.system('move allweights_formatted.h outputs/.')
    os.system('move input_image.txt outputs/.')
    os.system('move input_image_normalised.txt outputs/.')
